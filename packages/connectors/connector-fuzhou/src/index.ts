...
import { type FuzhouConnectorConfig, fuzhouConnectorConfigGuard } from './types.js';
import {
...
const _getUserInfo = async (
  ...
  try {
    ...
    const randomEmail = genDigitRandom(8) + String(rawData.id) + '@noreply.fzu.wispaper.ai';
